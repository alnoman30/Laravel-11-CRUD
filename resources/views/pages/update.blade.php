        ...
        <div class="row d-flex justify-content-center">          
            <div class="col-md-10">
                <div class="card border-0 shadow-lg my-4">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('update', $prod->id)}}" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea placeholder="" class="form-control" name="description" cols="30" rows="5" >{{ $prod->description }}</textarea>
                                @error('description')
                                    <div class="alert alert-danger">{{ $message }}</div>
                              @enderror
                              </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="sku" name="sku" value="{{ $prod->sku }}">
                                @error('sku')
                                    <div class="alert alert-danger">{{ $message }}</div>
                              @enderror
                              </div>
                              ...
                              <div class="mb-3">
                                ...
                                <input type="in" class="form-control" id="price" name="price" value="{{ $prod->price }}">
                                @error('price')
                                    <div class="alert alert-danger">{{ $message }}</div>
                              @enderror
                              </div>
                              ...
                              <div class="mb-3">
                                ...
                                @if ($prod->image != "")
                                    <img   src="{{ asset('uploads/'.$prod->image) }}" alt="" style="width: 180px; margin-top: 10px;">
                                @endif
                              </div>
